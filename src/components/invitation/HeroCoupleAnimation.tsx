...
export function HeroCoupleAnimation({ tenant, themeConfig }: Props) {
  ...
  return (
    <motion.div
      ...
      className="relative mx-auto mb-5 flex w-full max-w-[28rem] items-end justify-center gap-2 px-2 sm:gap-3 md:mb-8 md:max-w-[36rem] md:gap-8"
      style={{ color: "#FFFFFF" }}
    >
      <div
        aria-hidden="true"
        className="absolute inset-x-8 bottom-4 -z-10 h-16 blur-2xl md:bottom-6 md:h-24"
        style={{
          background: `radial-gradient(ellipse at center, ${themeConfig.accentColor}55 0%, transparent 70%)`,
        }}
      />
